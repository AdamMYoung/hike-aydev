const About = async () => {
  return (
    <div className="p-4 flex flex-col gap-4">
      <p>
        hike.aydev.uk provides a simple way to track your progress on Wainwrights and other fells across the British
        Isles. The project is built using Next.JS, making use of React Server Components and Server Actions which are
        currently in beta.
      </p>
      <p>
        Data is provided by{" "}
